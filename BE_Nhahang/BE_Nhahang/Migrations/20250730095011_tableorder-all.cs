...
{
    /// <inheritdoc />
    public partial class tableorderall : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TableImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TableImages_Tables_TableId",
                        column: x => x.TableId,
                        principalTable: "Tables",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TableOrders_TableBookings_BookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableImages_TableId",
                table: "TableImages",
                column: "TableId");

            migrationBuilder.CreateIndex(
                name: "IX_TableOrders_BookingId",
                table: "TableOrders",
                column: "BookingId");
        }
